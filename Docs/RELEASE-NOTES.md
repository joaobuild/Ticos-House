...
- Apenas um inimigo visível e ativo por vez. Após sua eliminação, o próximo aparece em 0,25 s; inimigos aguardando não atiram. Vida e munição são preservadas.
...
Testes automáticos cobrem transição sem proteção, ataque contínuo, entrada sequencial sem sobreposição, derrota por tempo, tiros, headshots, comunicação, partida até 13, esconderijo, Final Hunt e reinício. O balanceamento ainda requer experiência humana; testes automatizados não certificam dificuldade subjetiva.
